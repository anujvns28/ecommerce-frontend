...
const UpdateProfileImg = ({setChangeImg}) => {
  ...
  return (
    <div className='fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm'>
     <div className='flex h-[500px] w-[600px] py-7 items-center justify-center flex-col rounded-md gap-4 bg-slate-100 text-white border border-black p-5'>
...

     {
        ...
        className='py-2 px-4 font-semibold bg-yellow-400 rounded-md text-black items-start w-[20%]'>{userLoading ? "Updating...": "Update"}</button>
        </div>
     }
    </div>
    </div>
